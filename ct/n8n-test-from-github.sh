#!/usr/bin/env bash
# Test-Version: Verwendet das GitHub-Repo chrikodo/ProxmoxVE mit Branch test-n8n-local
source <(curl -fsSL https://raw.githubusercontent.com/chrikodo/ProxmoxVE/test-n8n-local/misc/build.func)
