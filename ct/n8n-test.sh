#!/usr/bin/env bash
# Test-Version: Verwendet das GitHub-Repo chrikodo/ProxmoxVE mit Branch fix-n8n-debian13-deps
source <(curl -fsSL https://raw.githubusercontent.com/chrikodo/ProxmoxVE/fix-n8n-debian13-deps/misc/build.func)
